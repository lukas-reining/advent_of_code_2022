...
export function initialBridge(): Bridge {
  ...
  bridge[MapSize / 2][MapSize / 2] = { state: "S", visited: true };
...
export function solve() {
  ...
  // let result = doMove(bridge, instructions[0]);
  // result = doMove(result, instructions[1]);
  // result = doMove(result, instructions[2]);
  // result = doMove(result, instructions[3]);
  // result = doMove(result, instructions[4]);
  // result = doMove(result, instructions[5]);
